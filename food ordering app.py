...
class admin:
    ...
    food_item_list={1:{'Name' : 'Spring Roll' , 'Quantity' : '2 piece' , 'Price' : 40 , 'Discount(%)' : 10 , "Stock" : 50}, 2:{'Name' : 'Hakka Noodles' , 'Quantity' : '200gm' , 'Price' : 150 , 'Discount(%)' : 5 , "Stock" : 55}, 3:{'Name' : 'Chocolate Truffle Cake' , 'Quantity' : '1 piece' , 'Price' : 50 , 'Discount(%)' : 2 , "Stock" : 25}, 4:{'Name' : 'Black Current Ice Cream' , 'Quantity' : '2 scoop' , 'Price' : 65 , 'Discount(%)' : 2 , "Stock" : 250}, 5:{'Name' : 'Chicken Burger' , 'Quantity' : '1' , 'Price' : 120 , 'Discount(%)' : 15 , "Stock" : 150}}
    user_details = {}
    user_login=[]
    admin_details = {}
    count=5
    ...
    def __init__(self):
            print("tastytreat-Food Ordering App")
...
class user(admin):
    ...
    def __init__(self):
        print("tastytreat-Order Food Fresh!")
        time.sleep(1)
        self.admin_home()
